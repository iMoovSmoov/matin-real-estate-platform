          ...
          {categories.map((c) => (
            <button
              ...
              className={cn(
                ...
                cat === c
                  ? "bg-azure text-white"
                  : "border border-white/10 bg-white/[0.03] text-slate-300 hover:border-azure/40 hover:text-white",
              )}
            >
              {c}
            </button>
              ...
              <div className="mt-3 flex items-center justify-between border-t border-white/[0.06] pt-3">
                {connected && i.records != null ? (
                  <span className="inline-flex items-center gap-1.5 text-[0.74rem] text-slate-300/70">
                    <Database className="h-3.5 w-3.5 text-azure-bright" />
                ...
                {connected ? (
                  ...
                  <button className="inline-flex items-center gap-1 text-[0.74rem] font-semibold text-azure-bright hover:text-azure-300">
