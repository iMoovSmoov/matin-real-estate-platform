  ...
  return (
    ...
    >
      <div className="flex flex-1 items-center gap-2 px-3">
        <MapPin className={`h-5 w-5 ${dark ? "text-white/70" : "text-azure"}`} />
        <input
          value={q}
      ...
      <select
        ...
        className={`rounded-full px-3 py-2.5 text-[0.9rem] focus:outline-none sm:border-l ${
          dark ? "bg-transparent text-white sm:border-white/20" : "bg-transparent text-ink/80 sm:border-ink/10"
        }`}
      >
