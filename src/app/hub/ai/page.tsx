  ...
  return (
    <div className="mx-auto max-w-[1400px] space-y-6 px-4 py-6 md:px-6 md:py-8">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.07] to-white/[0.04] px-6 py-7">
        <div className="pointer-events-none absolute -right-10 top-0 h-56 w-56 rounded-full bg-white/[0.12] blur-3xl" />
        ...
        {TOOLS.map((t) => {
          ...
          return (
            <Link
              key={t.href}
              href={t.href}
              className="group relative flex flex-col rounded-2xl border border-white/10 bg-white/[0.045] p-5 transition-all hover:-translate-y-0.5 hover:border-white/30 hover:bg-azure/[0.05] hover:shadow-glow"
            >
              <div className="flex items-center justify-between">
                <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-white/[0.1] text-white ring-1 ring-inset ring-white/12 transition-colors group-hover:bg-white/[0.12]">
                  <Icon className="h-5 w-5" />
                </span>
                <ArrowUpRight className="h-4 w-4 text-slate-300/40 transition-all group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-white" />
              </div>
              <p className="mt-4 text-[0.62rem] font-semibold uppercase tracking-wider text-white/70">
                {t.pillar}
              </p>
              ...
              <span className="mt-4 inline-flex items-center gap-1 text-[0.78rem] font-semibold text-white opacity-80 transition-opacity group-hover:opacity-100">
